...
public final class BasicStyle {
    ...
    /** Chip 水平内边距 px。 */
    public final float chipPaddingHorizontal;
    /** Chip 间距 px。 */
    public final float chipGap;
    /** 搜索栏高度 px。 */
    public final float searchBarHeight;
    /** 搜索栏图标区域宽度 px。 */
    public final float searchBarIconWidth;
    /** 搜索栏图标尺寸 px。 */
    public final float searchBarIconSize;
    /** Toast 最小高度 px。 */
    ...
    /** 是否绘制按钮底部托起阴影层，来自 style_token islandStyle.rules.buttonRaisedShadowEnabled。 */
    public final boolean buttonRaisedShadowEnabled;
    /** Switch 启用态透明度。 */
    ...
    public BasicStyle(
            ...
            float badgeHeight,
            float chipHeight,
            float chipPaddingHorizontal,
            float chipGap,
            float searchBarHeight,
            float searchBarIconWidth,
            float searchBarIconSize,
        ...
        this.chipPaddingHorizontal = chipPaddingHorizontal;
        this.chipGap = chipGap;
        this.searchBarHeight = searchBarHeight;
        this.searchBarIconWidth = searchBarIconWidth;
        this.searchBarIconSize = searchBarIconSize;
        ...
        this.buttonRaisedShadowEnabled = buttonRaisedShadowEnabled;
