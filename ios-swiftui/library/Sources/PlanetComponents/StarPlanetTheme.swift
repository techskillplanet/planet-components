...
public struct StarPlanetTheme {
    ...
    /// Flat switch track off — aligns with RN `switchOffBg` / `borderDefault` `#C8EAFF`.
    public var switchOffBackground = Color(red: 0.784, green: 0.918, blue: 1.0)
    /// Flat switch track on — aligns with RN `switchOnBg` / `brandPrimary` `#31A8FF`.
    public var switchOnBackground = Color(red: 0.192, green: 0.659, blue: 1.0)
    /// Flat switch thumb — aligns with RN `switchHandleBg` `#FFFFFF`.
    public var switchHandleBackground = Color.white
    ...
    public static let night = StarPlanetTheme(
        ...
        switchOffBackground: Color(red: 0.165, green: 0.247, blue: 0.361),
        switchOnBackground: Color(red: 0.192, green: 0.659, blue: 1.0),
        switchHandleBackground: .white
    )
    public static let mint = StarPlanetTheme(
        ...
        switchOffBackground: Color(red: 0.741, green: 0.937, blue: 0.886),
        switchOnBackground: Color(red: 0.125, green: 0.749, blue: 0.663),
        switchHandleBackground: .white
    )
}